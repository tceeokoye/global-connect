...
const ServiceJobs = () => {
  const features = [
    { icon: Search, title: "Job Matching", description: "Connect with verified international employers" },
    { icon: UserCheck, title: "Candidate Verification", description: "Professional screening and employer liaison" },
    { icon: TrendingUp, title: "Work Sponsorship", description: "Visa support and work permit assistance" },
    { icon: Briefcase, title: "Career Development", description: "Post-placement support and growth opportunities" },
  ];
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {features.map((feature, index) => (
              <ScrollAnimate key={feature.title} index={index}>
                <motion.div
          ...
          <ScrollAnimate index={0}>
            <div className="bg-card rounded-2xl overflow-hidden shadow-elegant grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.4 }} className="h-64 lg:h-auto overflow-hidden">
                <motion.img

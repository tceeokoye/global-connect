...
export default function Partners() {
  ...
  const partnerTypes = [
    
    {
      ...
      description:
        "Universities and colleges seeking diverse international students",
    },
    {
      image: partnerBusiness,
      title: "Business Organizations",
      description:
        "Companies looking for strategic partnerships and investment",
    },
    {
      image: partnerAgencies,
      title: "International Agencies",
      description:
        "Government and non-profit organizations focused on global development",
    },
    {
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <ScrollAnimate index={0} total={1} className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We collaborate with leading institutions, businesses, and
              organizations worldwide to create opportunities for African
            ...
            {partnerTypes.map((type, index) => (
              ...
              >
                ...
                />
                  ...
                  <div className="p-8">
                    <h3 className="text-2xl text-nowrap font-bold mb-3">
                      {type.title}
                    </h3>
          ...
          <ScrollAnimate index={0} total={1}>
            <motion.div className="bg-card rounded-2xl overflow-hidden shadow-elegant">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div className="p-10">
                  ...
                  <p className="text-xl text-muted-foreground mb-8">
                    Join our network of global partners committed to creating
                    opportunities for African talent and fostering international
                    collaboration.
                  </p>
                  ...
                  <div className="mt-10">
                    <Link href="/contact">
                      <Button
                        size="lg"
                        className="shadow-elegant text-lg px-10"
                      >
                        Partner With Us
                      </Button>
                    </Link>

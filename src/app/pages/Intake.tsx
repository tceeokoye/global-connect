  ...
  <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
    <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md text-center">
      ...
      <p className="text-gray-600 mb-6">
        Thank you for your submission. We'll contact you within 3–5 business
        days.
      </p>
      <Button
        onClick={onClose}
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground">
              Whether you're a student, professional, investor, or organization,
              this is your first step. Our team will contact you within 3–5
              business days.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="travel">Travel & Consulate</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <p className="text-sm text-muted-foreground text-center">
                All submissions are reviewed within 72 hours. Confidentiality
                guaranteed.
              </p>
            </form>
          </motion.div>

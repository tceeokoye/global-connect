...
export default function ServiceTravel () {
          ...
          <AnimatedBlock direction="up">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Enhanced consulate services through premium concierge solutions.
                We provide comprehensive support for passport services, visa
                applications, customs navigation, consolidated shipping, and
            ...
            <AnimatedBlock direction="right">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                  We streamline international travel processes through enhanced
                  consulate services and premium concierge solutions, ensuring
                  smooth transitions for business and leisure travelers.
                </p>
